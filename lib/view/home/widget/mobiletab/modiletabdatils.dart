...
class Mobilecategorydatils extends StatelessWidget {
  Mobilecategorydatils(
      {super.key, required this.Mobileitem, required this.index});
  final MobileData Mobileitem;
